...
url_template <- 'https://www.imdb.com/title/tt10366206/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
   Movie_Title = rep("John Wick: Chapter 4", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie_5.csv", row.names = FALSE)
```
