...
url_template <- 'https://www.imdb.com/title/tt9362930/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Blue Beetle", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie_4.csv", row.names = FALSE)
```
