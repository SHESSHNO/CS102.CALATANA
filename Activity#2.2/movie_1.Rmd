...
url_template <- 'https://www.imdb.com/title/tt13375076/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
   Movie_Title = rep("The Pope's Exorcist", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie_1.csv", row.names = FALSE)
```
