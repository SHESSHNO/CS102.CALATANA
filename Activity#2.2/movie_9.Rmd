...
url_template <- 'https://www.imdb.com/title/tt3741700/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Godzilla: King of the Monsters", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie_9.csv", row.names = FALSE)
```
