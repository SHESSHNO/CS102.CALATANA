...
url_template <- 'https://www.imdb.com/title/tt7286456/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Joker", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie_8.csv", row.names = FALSE)
```
