...
url_template <- 'https://www.imdb.com/title/tt1270797/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Venom", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie_10.csv", row.names = FALSE)
```
