...
url_template <- 'https://www.imdb.com/title/tt4495098/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("Gran Turismo", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie_3.csv", row.names = FALSE)
```
