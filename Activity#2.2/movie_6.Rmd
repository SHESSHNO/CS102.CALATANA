...
url_template <- 'https://www.imdb.com/title/tt17024450/reviews/_ajax?ref_=undefined&paginationKey=%s'
```
...
DataFrame <- data.frame(
  Movie_Title = rep("The Equalizer 3", reviews_to_scrape),
...
```{r}
# Save as CSV
write.csv(DataFrame, file = "movie_6.csv", row.names = FALSE)
```
