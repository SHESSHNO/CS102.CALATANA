...
url <- "https://www.amazon.com/s?k=versace+eros&crid=1C7I7Q0WKXVUL&sprefix=versa%2Caps%2C5386&ref=nb_sb_ss_ts-doa-p_1_5"
...
write.csv(product_df1, "2nd_item.csv")

product_df1$Category <- "perfume"

product_df1 <- product_df1[, c("Category", names(product_df1)[-which(names(product_df1) == "Category")])]

write.csv(product_df1, "2nd_product.csv", row.names = FALSE)
